...
public class Drivetrain extends SubsystemBase {
    ...
    */
    public Drivetrain() {
        ...
        backRight = new WPI_TalonFX(14);

        frontLeft = new WPI_TalonFX(10);

        frontRight = new WPI_TalonFX(13);
    ...
    public double getRightEncoderDistance() {
        LOG.trace("RightEncoderDistance: {}", getRightEncoderPostion() * DriveConstants.testChassisDistancePerTick);
        return getRightEncoderPostion() * DriveConstants.testChassisDistancePerTick;
    }
