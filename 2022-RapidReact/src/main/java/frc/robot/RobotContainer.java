...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    final JoystickButton climberUpButton = new JoystickButton(operatorPad, XboxController.Button.kRightBumper.value);//Could not find D pad for Up or Down
    ...
    final JoystickButton climberDownButton = new JoystickButton(operatorPad, XboxController.Button.kLeftBumper.value);//Could not find D pad for Up or Down
    climberDownButton.whenPressed(new ClimberDownCommand(m_climber), true);
    SmartDashboard.putData("climberUp", new ClimberDownCommand(m_climber));
