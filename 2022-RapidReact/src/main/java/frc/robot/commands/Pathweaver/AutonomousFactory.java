...
public class AutonomousFactory {
    ...
    private RamseteCommand createRamseteCommand(String name, Trajectory trajectory) {
        ...
        // DriveConstants.kDriveKinematics, m_drivetrain::getWheelSpeeds, new
        // PIDController(DriveConstants.kPDriveVel, DriveConstants.kIDriveVel,
        // DriveConstants.kDDriveVel), new PIDController(DriveConstants.kPDriveVel,
        ...
        var autoVoltageConstraint = new DifferentialDriveVoltageConstraint(
                new SimpleMotorFeedforward(DriveConstants.ksVolts, DriveConstants.kvVoltSecondsPerMeter,
                        DriveConstants.kaVoltSecondsSquaredPerMeter),
                DriveConstants.kDriveKinematics, DriveConstants.maxDriveVoltage);
        ...
        Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(new Pose2d(0, 0, new Rotation2d(0)),
                List.of(), new Pose2d(45, 0, new Rotation2d(0)), config);
        RamseteCommand ramseteCommand = new RamseteCommandProxy(name, exampleTrajectory, m_drivetrain::getPose,
    ...
    public Command createShootBackupIntake() {
        ...
        scGroup.addCommands(new ParallelCommandGroup(createRamseteCommand("BlueBottom2Rev",
                TrajectoryFactory.getBlueBottom2For())/* , createIntakeCommand(m_belt) */));
