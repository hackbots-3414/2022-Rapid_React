...
public class DriveStraight extends CommandBase {
    ...
    public void initialize() {
        ...
        this.distance = Math.abs(this.distance / 0.001198047515388888); // converts from motor ticks to inches (wheel diameter is 6.432 inches)
    ...
    public boolean isFinished() {
        LOG.trace("Average Encoder: {}\nLeft Encoder: {}\nRight Encoder: {}", m_drivetrain.getAverageEncoderPosition(),
                m_drivetrain.getLeftEncoderPosition(), m_drivetrain.getRightEncoderPosition());
