...
public class AutonomousFactory {
    ...
    public SequentialCommandGroup create4BallAuton() {
        ...
        group.addCommands(createIntakeCommand(false));
        group.addCommands(createShooterCommand());
        group.addCommands(new ParallelCommandGroup(createIntakeCommand(true), new SequentialCommandGroup(createRamseteCommand(TrajectoryFactory.getPath("5BallAutonPart5", true)), createRamseteCommand(TrajectoryFactory.getPath("5BallAutonPart6", false)))));
        group.addCommands(createIntakeCommand(false));
        group.addCommands(createShooterCommand());
